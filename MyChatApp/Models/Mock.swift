...
struct Mock {
    ...
    static let mockMessages1: [Message] = [
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Hi Kelly, I wanted to introduce myself. My name is Bea and I’ll be your dedicated sales rep. Don’t hesitate to reach out if you need anything. That’s what I’m here for :-}",
                isIncoming: true,
                unread: false),
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Holiday weekend cancelation alert! Some rooms opened and we’re giving away two FREE nights in the lodge, lift tickets included. Text “PoconosMDW” to enter!",
                isIncoming: false,
                unread: false),
        
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Hey there! As a special thank you for joining the Run Family, enter code RUN20 at checkout for 20% off your next order! http://text.tl/mJPLPM",
                isIncoming: false,
                unread: false),
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Hey Annie, it’s Russ from Wag! I wanted to welcome you to our text program. Our newest way to reach customers. We look forward to chatting with you more soon!",
                isIncoming: false,
                unread: false),
    ...
    static let mockMessages2: [Message] = [
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Cornwall staff, lock your doors and engage in code red protocol. The office is on lockdown. Shelter in a safe place and wait for an all clear text to arrive.",
                isIncoming: false,
                unread: false),
        
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Sam, your rent payment for Jan 19 has been received. $1,300 will be drafted from your Wells Fargo Account ******0000 within 24-48 business hours. Thank you!",
                isIncoming: true,
                unread: false),
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Hey Jessica! I wanted to let you know a property on Boylston street opened up that I think you’d be interested in. Would you like me to text you the info for the open house?",
                isIncoming: true,
                unread: false)
    ]
    ...
    static let mockMessages3: [Message] = [
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Hi Kryss! I wanted to introduce myself, I’m Pete. Just dropping in to let you know I’m a real person, not a robot, and I’m here to answer any of your questions 😄",
                isIncoming: false,
                unread: false),
        ...
        Message(date: Date().addingTimeInterval(TimeInterval(Double.random(in: -1000000 ... -1))),
                text: "Laura, you can text us at any time, but we wanted to share a link to our help center in case you need assistance outside business hours! http://txt.tl/mJPLPM",
                isIncoming: false,
                unread: false)
    ]
